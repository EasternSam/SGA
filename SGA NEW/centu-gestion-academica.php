 ...
 * Description: Panel a medida para gestionar inscripciones, cursos, matriculación, pagos (Azul) y reportes avanzados en PDF.
 * Version: 12.0 (Refactorizado)
...
define('SGA_PLUGIN_VERSION', '12.0');
